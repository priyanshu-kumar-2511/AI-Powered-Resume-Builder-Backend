...
public class JwtService {
    ...
    /**
     * Generates a full JWT for a User entity, embedding roles, userId, and subscriptionPlan claims.
     * Used after plan upgrades so the frontend receives a fresh token immediately.
     */
