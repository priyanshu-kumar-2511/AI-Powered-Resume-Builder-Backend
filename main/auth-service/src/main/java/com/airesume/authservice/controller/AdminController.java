...
public class AdminController {
    ...
    private final com.airesume.authservice.service.PaymentService paymentService;

    @GetMapping("/subscriptions")
    public ResponseEntity<org.springframework.data.domain.Page<com.airesume.authservice.dto.AdminSubscriptionResponse>> getSubscriptions(
            @org.springframework.data.web.PageableDefault(size = 20) org.springframework.data.domain.Pageable pageable) {
        return ResponseEntity.ok(paymentService.getAdminSubscriptions(pageable));
    }

    @GetMapping("/subscriptions/stats")
    public ResponseEntity<com.airesume.authservice.dto.SubscriptionStatsResponse> getSubscriptionStats() {
